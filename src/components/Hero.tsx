      ...
      <div ref={heroRef} className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-3xl mx-auto text-center space-y-8">
          <div className="space-y-4">
            <h1
              className="text-4xl sm:text-5xl md:text-6xl font-bold leading-tight animate-fade-in"
            ...
            <p
              className="text-xl md:text-2xl text-foreground/80 animate-fade-in"
          ...
          >
            ...
            >
              {strings.Hero.buttonExploreVision}
            </button>
            ...
            >
              {strings.Hero.buttonCurrentInitiatives}
            </a>
          </div>
        </div>
      </div>
