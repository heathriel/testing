    ...
    >
      <div className="p-6 md:p-8 border-b border-foreground/10">
        <div className="flex items-center justify-between flex-wrap gap-4 mb-4">
          <span className="tag tag-moment">Moment {moment.id}</span>
          <div className="flex gap-2">
            <span className="tag tag-ask">
              {moment.asks.length} {moment.asks.length === 1 ? 'Ask' : 'Asks'}
            </span>
            <span className="tag tag-offer">
              {moment.offers.length} {moment.offers.length === 1 ? 'Offer' : 'Offers'}
            </span>
          </div>
        </div>
      ...
      <div className="p-6 md:p-8">
        ...
        {activeTab === 'asks' && (
          <div className="animate-fade-in">
            <h3 className="text-lg font-semibold mb-4">What Mary Needs</h3>
        ...
        {activeTab === 'offers' && (
          <div className="animate-fade-in">
            <h3 className="text-lg font-semibold mb-4">What Mary Offers</h3>
            <div className="space-y-6">
